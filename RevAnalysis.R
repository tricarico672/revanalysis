...
require(pacman)
p_load(tidyverse, readxl, openxlsx, ggthemes, roxygen2, devtools)
options(scipen=999) #avoids scientific formatting
theme_set(theme_bw()) #change theme here if needed
